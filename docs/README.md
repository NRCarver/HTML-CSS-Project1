...
[Visit the website here](https://nrcarver.github.io/HTML-CSS-Project1/)
...
![alt text](../assets/images/readme-images/amiresponsive.png)

Image produced at [Am I Responsive](https://ui.dev/amiresponsive)
...
[Wireframes](../assets/images/readme-images/website-wireframes.png)
...
- [Font Awesome](https://fontawesome.com/) - Used to provide in the Hacks section and also in the Footer.

- [Chrome Dev Tools](https://developers.google.com/web/tools/chrome-devtools) - Used to check my work periodically, debug my code when needed and also test the responsiveness of my website.

- [GitHub](https://www.github.com/) - Used to store my code after pushing from Gitpod.

- [GitPod](https://www.gitpod.io/) - Used as a development environment.

- Git - Used for version control of my code.

- [Sketch](https://sketch.com/) - Used to create the wireframes for the project.

- [Google Fonts](https://getbootstrap.com) - Used to style my website fonts.

- [W3C Markup Validation Service](https://validator.w3.org/) - Used to validate all of my HTML code.

- [W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/) - Used to validate all of my CSS code.

- [Color Contrast Accessibility Validator](https://color.a11y.com/Contrast/) - Used to check my website colours had enough contrast for accessibility purposes.

- [Optimizilla Image Compressor](https://imagecompressor.com/) - Used to compress the images.

- [Dirty Markup Formatter](https://www.10bestdesign.com/dirtymarkup/) - Used to standardise and format my HTML and CSS code.

# UX Stories Testing

Below are website images for reference with the UX Stories Testing.

![alt text](../assets/images/readme-images/header-section-1.png)
![alt text](../assets/images/readme-images/section-2-closed.png)
![alt text](../assets/images/readme-images/section-2-open.png)
![alt text](../assets/images/readme-images/section-3.png)
...
I used the [W3C Markup Validation Service](https://validator.w3.org/) and [W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/) to check my code. I used these periodically to check my code and there are no errors present in the final version.
...
![alt text](../assets/images/readme-images/lighthouse-desktop.png)
![alt text](../assets/images/readme-images/lighthouse-mobile.png)
![alt text](../assets/images/readme-images/color-contrast-failed-blueblack.png)
...
![alt text](../assets/images/readme-images/colorcontrast-passed-whitepinkblue.png)
![alt text](../assets/images/readme-images/colorcontrast-passed-blueblack.png)
...
![alt text](../assets/images/readme-images/github-1.png)
![alt text](../assets/images/readme-images/github-2.png)
![alt text](../assets/images/readme-images/github-3.png)
